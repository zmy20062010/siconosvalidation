...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    SP::LagrangianDS dynamicalsystem(new LagrangianDS(q0, v0, "BouncingManipulatorPlugin:mass"));
    // external plug-in for the dynamical system in terms of different equation terms
    dynamicalsystem->setComputeNNLFunction("BouncingManipulatorPlugin", "NNL");
    dynamicalsystem->setComputeJacobianNNLqDotFunction("BouncingManipulatorPlugin", "jacobNNLv");
    dynamicalsystem->setComputeJacobianNNLqFunction("BouncingManipulatorPlugin", "jacobNNLq");

    dynamicalsystem->setComputeFIntFunction("BouncingManipulatorPlugin", "FInt");
    dynamicalsystem->setComputeJacobianFIntqDotFunction("BouncingManipulatorPlugin", "jacobFintv");
    dynamicalsystem->setComputeJacobianFIntqFunction("BouncingManipulatorPlugin", "jacobFintq");

    dynamicalsystem->setComputeFExtFunction("BouncingManipulatorPlugin", "FExt");
    ...
    SP::Relation relation(new LagrangianRheonomousR("BouncingManipulatorPlugin:Gap", "BouncingManipulatorPlugin:jacobGapq", "BouncingManipulatorPlugin:jacobGapt"));
